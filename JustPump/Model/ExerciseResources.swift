//
//  ExerciseResources.swift
//  JustPump
//
//  Created by Edward Fetzer on 08.11.22.
//
...
func getChestExercises() -> [Exercise] {
    ...
    Exercise(
        ...
        exerciseImageRes: "liegestütze1_1",
    ...
    Exercise(
        ...
        exerciseImageRes: "positiveLiegestütze",
    ...
    Exercise(
        ...
        exerciseImageRes: "negativeLiegestütze",
...
func getShoulderExercises() -> [Exercise] {
    ...
    Exercise(
        exerciseName: "Seitenheben Kurzhantel",
        exerciseImageRes: "seitenhebenKurzhantel",
    ...
    Exercise(
        exerciseName: "Frontheben Kurzhantel",
        exerciseImageRes: "fronthebenKurzhantel",
        exerciseDescription: "Körperposition\nZunächst stellst du dich aufrecht hin. Deine Beine sollten hüftbreit auseinander sein, damit du einen möglichst stabilen Stand hast. Deine Knie sind leicht gebeugt. Im Anschluss nimmst du eine Kurzhantel auf. Dafür wählst du den Obergriff. Dein Oberkörper ist aufrecht. Tendenziell solltest du den unteren Rücken in einem leichten Hohlkreuz halten, damit du deine Wirbelsäule schützt. Die zweite Hand kannst du an der Hüfte ablegen oder hinter deinem Rücken halten. Richte nun deinen Blick nach vorne und beginne mit dem Frontheben mit der Kurzhantel einarmig.\n\nBewegungsausführung\nLangsam und kontrolliert führst du deinen Arm mit der Kurzhantel nach oben. Während der Aufwärtsbewegung atmest du aus. Du stoppst die Bewegung, wenn sich die Kurzhantel mit deinem Arm parallel zum Boden befindet. Im Anschluss atmest du ein und kehrst langsam in die Ausgangsposition zurück. Erst wenn du alle Wiederholungen abgeschlossen hast, wendest du dich der anderen Körperseite zu."),
    
    Exercise(
        exerciseName: "Vorgebeugtes Seitenheben",
        exerciseImageRes: "vorgebeugtesSeitenheben1",
...
func getBackExercises() -> [Exercise] {
    ...
    Exercise(
        exerciseName: "Rudern am Kabelzug",
        exerciseImageRes: "rudern",
    ...
    Exercise(
        exerciseName: "Klassisches Kreuzheben",
        exerciseImageRes: "kreuzheben",
...
func getArmExercises() -> [Exercise] {
    ...
    Exercise(
        exerciseName: "Kurzhantel Curls",
        exerciseImageRes: "curlsStehend",
    ...
    Exercise(
        exerciseName: "Curls an der Bizepsmaschiene",
        exerciseImageRes: "bicepsMaschiene",
    ...
    Exercise(
        exerciseName: "Trizepsdrücken am Kabel: Pushdown",
        exerciseImageRes: "trizepsAmKabel",
    ...
    Exercise(
        exerciseName: "Trizepsdrücken am Kabel: über Kopf",
        exerciseImageRes: "trizepsUeberKopf",
    ...
    Exercise(
        exerciseName: "Trizepsdrücken an der Trizepsmaschiene",
        exerciseImageRes: "trizepsMaschiene",
...
func getAbdominalExercises() -> [Exercise] {
    return [
        
    Exercise(
        exerciseName: "Sit-Ups",
        exerciseImageRes: "situps",
    ...
    Exercise(
        exerciseName: "Cross Crunches",
        exerciseImageRes: "crossChrunches",
    ...
    Exercise(
        exerciseName: "Hüftheben an der Bank",
        exerciseImageRes: "huefthebenBank",
...
func getLegExercises() -> [Exercise] {
    ...
    Exercise(
        exerciseName: "Beinstrecker an der Maschine",
        exerciseImageRes: "beinstrecker",
    ...
    Exercise(
        exerciseName: "Kniebeugen mit der Langhantel",
        exerciseImageRes: "kniebeugeLanghantel",
